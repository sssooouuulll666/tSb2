...
def main(page: Page):
    ...
    def color_change(e):
        ...
        global color
        color = choice(_color)
        banner.controls = [Text(spans=[TextSpan('SPERMA1488', TextStyle(size=95, foreground=Paint(color=color, stroke_width=9, stroke_join='round', style='stroke')))], font_family='Consolas'), Text(spans=[TextSpan('SPERMA1488', TextStyle(size=95, color=color))], font_family='Consolas')]
    ...
    # Баннер
    banner = Stack([Text(spans=[TextSpan('SPERMA1488', TextStyle(size=95, foreground=Paint(color=color, stroke_width=9, stroke_join='round', style='stroke')))], font_family='Consolas'), Text(spans=[TextSpan('SPERMA1488', TextStyle(size=95, color=color))], font_family='Consolas')])
    ...
    def ADD():
        ...
        page.add(
                ...
                attack_button,
                Text('\n', size=12),
                Row([IconButton(icon='11111', icon_size=48, tooltip='11111', url='11111', icon_color=color),
                    IconButton(icon='22222', icon_size=48, tooltip='22222', url='22222', icon_color=color),
                    IconButton(icon='33333', icon_size=48, tooltip='33333', url='33333', icon_color=color),
